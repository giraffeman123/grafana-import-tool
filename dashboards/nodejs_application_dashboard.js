...
const nodejs_application_dashboard = 
{
  "dashboard":{
    ...
    "panels": [
      {
        ...
        "targets": [
          {
            "expr": "irate(node_process_cpu_seconds_total[2m]) * 100",
            "format": "time_series",
            "interval": "",
            "intervalFactor": 1,
      ...
      },
      {
        ...
        "targets": [
          {
            "expr": "node_nodejs_eventloop_lag_seconds",
            "format": "time_series",
            "interval": "",
            "intervalFactor": 1,
      ...
      },
      {
        ...
        "targets": [
          {
            "expr": "sum(node_nodejs_version_info) by (version)",
            "format": "time_series",
            "instant": false,
            "interval": "",
            "intervalFactor": 1,
      ...
      },
      {
        ...
        "targets": [
          {
            "expr": "sum(changes(node_process_start_time_seconds[1m]))",
            "format": "time_series",
            "interval": "",
            "intervalFactor": 1,
            "legendFormat": "{{instance}}",
      ...
      },
      {
        ...
        "targets": [
          {
            "expr": "node_process_resident_memory_bytes",
            "format": "time_series",
            "interval": "",
            "intervalFactor": 1,
          ...
          {
            "expr": "node_nodejs_heap_size_total_bytes",
            "format": "time_series",
            "interval": "",
            "intervalFactor": 1,
          ...
          {
            "expr": "node_nodejs_heap_size_used_bytes",
            "format": "time_series",
            "interval": "",
            "intervalFactor": 1,
          ...
          {
            "expr": "node_nodejs_external_memory_bytes",
            "format": "time_series",
            "interval": "",
            "intervalFactor": 1,
      ...
      },
      {
        ...
        "targets": [
          {
            "expr": "node_nodejs_heap_space_size_total_bytes",
            "format": "time_series",
            "interval": "",
            "intervalFactor": 1,
      ...
      },
      {
        ...
        "targets": [
          {
            "expr": "node_nodejs_heap_space_size_used_bytes",
            "format": "time_series",
            "interval": "",
            "intervalFactor": 1,
      ...
      },
      {
        ...
        "targets": [
          {
            "expr": "node_nodejs_heap_space_size_available_bytes",
            "format": "time_series",
            "interval": "",
            "intervalFactor": 1,
            "legendFormat": "Heap Used - {{instance}} - {{space}}",
    ...
    "timezone": "",
    "title": "API Test - NodeJS Application Dashboard",    
    "version": 1,
    "id": null,
    "uid": null,
  },
